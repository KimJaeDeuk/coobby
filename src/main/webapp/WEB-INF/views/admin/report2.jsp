              ...
              <div class="card-body">
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td> 4</td>
                    <td>X</td>
                    <td><div type="button" class="btn btn-block btn-danger">반려</div></td>
                  </tr>
                 ...
                 <tr>
                   ...
                   <td> 4</td>
                   <td>X</td>
                   <td><button type="submit" class="btn btn-block btn-success">완료</button></td>
                 </tr>
               ...
               <tr>
                 ...
                 <td> 4</td>
                 <td>X</td>
                 <td><button type="submit" class="btn btn-block btn-secondary">대기</button></td>
               </tr>
              ...
              <div class="card-body">
                ...
                <table id="example3" class="table table-bordered table-hover">
                 ...
                 <tr>
                   ...
                   <td> 4</td>
                   <td>X</td>
                   <td><div type="button" class="btn btn-block btn-success">완료</div></td>
                 </tr>
               ...
               <tr>
                 ...
                 <td> 4</td>
                 <td>X</td>
                 <td><div type="button" class="btn btn-block btn-secondary">대기</div></td>
               </tr>
