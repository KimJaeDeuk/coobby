...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<form action="saveFeed">
				...
				<div class="container">
					...
					<div class="col-md-6">						
						<table class="table">
							  <tr>
								<td>제목</td>
								<td><textarea name="fe_title" id="write_content" class="form-control" maxlength="1000" style="resize: none; height: 30px;" ></textarea></td>
							  </tr>
							  <tr>
								<td>내용</td>
								<td><textarea name="fe_content" id="write_content" class="form-control" maxlength="1000" style="resize: none; height: 150px;" ></textarea></td>
							  </tr>
							  <tr>
							  	<td>댓글 허용</td>
							  	<td>
			...
			<div class="updatebtn">
				<button type="submit" class="savebtn button button-3d button-rounded button-pink"><i class="icon-line-edit-3"></i>등록하기</button>
				<a href="MyFeed.html" class="button button-3d button-rounded button-blue"><i class="icon-line-arrow-left"></i>뒤로가기</a>
			</div>
		</form><!-- #content end -->
