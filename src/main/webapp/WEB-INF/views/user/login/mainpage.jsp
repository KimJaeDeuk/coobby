...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		============================================= -->
		<section id="slider"
			class="slider-element swiper_wrapper min-vh-75 bg-color"
			data-loop="true">
			...
			<!-- <div class="col-xl-6 col-lg-9 col-md-5 mt-xl-4 text-center text-xl-start">
				...
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<div class="container">
							<div
								class="position-absolute pos-y-end mb-3 row justify-content-lg-end w-100 col-mb-30">
								<div class="col-lg-auto col-md-8 col-10">
									<!-- <a href="demo-furniture-single.html" class="card d-flex flex-row" data-animate="fadeInLeft">
										<img src="images/my/main5.jpg" width="100" height="100" alt="Image" class="rounded-start">
										<div class="card-body px-4">
						...
						<div class="swiper-slide-bg"
							style="background-image: linear-gradient(to bottom, transparent, rgba(25, 53, 50, .9)), url('/resources/user/images/my/main2.jpg');"></div>
					</div>
					...
					<div class="swiper-slide">
						...
						<div class="container">
							<div
								class="position-absolute pos-y-end mb-3 row justify-content-lg-center w-100 col-mb-30">
				...
				<div class="slider-arrow-left">
					<svg xmlns="http://www.w3.org/2000/svg" width="52" height="52"
						...
						<circle cx="128" cy="128" r="96" fill="none" stroke="#FFF"
							stroke-miterlimit="10" stroke-width="12"></circle>
						<polyline points="144 92 104 128 144 164" fill="none"
							stroke="#FFF" stroke-linecap="round" stroke-linejoin="round"
							stroke-width="12"></polyline></svg>
				</div>
				<div class="slider-arrow-right">
					<svg xmlns="http://www.w3.org/2000/svg" width="52" height="52"
						...
						<circle cx="128" cy="128" r="96" fill="none" stroke="#FFF"
							stroke-miterlimit="10" stroke-width="12"></circle>
						<polyline points="116 92 156 128 116 164" fill="none"
							stroke="#FFF" stroke-linecap="round" stroke-linejoin="round"
							stroke-width="12"></polyline></svg>
				</div>
			</div>
		...
		<section id="content">
			<div class="content-wrap py-0">
						...
						<div class="row justify-content-center">
							...
							<div class="col-lg-9">
								<div class="row justify-content-center align-items-center text-center mx-auto">
									<div class="col center op-05"><img src="/resources/user/demos/furniture/images/sponsors/amazon.svg" alt="" width="100"></div>
									<div class="col center op-05"><img src="/resources/user/demos/furniture/images/sponsors/cnn.svg" alt="" width="100"></div>
									<div class="col center op-05"><img src="/resources/user/demos/furniture/images/sponsors/google.svg" alt="" width="100"></div>
									<div class="col center op-05"><img src="/resources/user/demos/furniture/images/sponsors/linkedin.svg" alt="" width="100"></div>
								</div>
								<div class="row justify-content-center align-items-center mx-auto text-center mt-3">
									<div class="col center op-05"><img src="/resources/user/demos/furniture/images/sponsors/netflix.svg" alt="" width="100"></div>
									<div class="col center op-05"><img src="/resources/user/demos/furniture/images/sponsors/jetblue.svg" alt="" width="100"></div>
									<div class="col center op-05"><img src="/resources/user/demos/furniture/images/sponsors/github.svg" alt="" width="100"></div>
								</div>
							</div>
						</div>
				...
				<div class="container-fluid">
					...
					<div class="text-center mt-6 mb-5">
						<h2 class="h1 fw-normal mb-4">
							<b>Popular</b> <span data-animate="svg-underline-animated"
								class="svg-underline nocolor"><span><b>recipe</b></span></span>
						</h2>
					...
					<div class="row item-categories gutter-20">
						<div class="col-lg-4 col-md-6">
							<a href="demo-forum-products.html" class="d-block h-op-09 op-ts"
								style="background: url('/resources/user/demos/furniture/images/categories/sofas.jpg') no-repeat center center; background-size: cover; height: 340px;">
								<h5 class="text-uppercase ls1 bg-white mb-0">★★★Top1</h5>
							</a>
						</div>
						<div class="col-lg-4 col-md-6">
							<a href="demo-forum-products.html" class="d-block h-op-09 op-ts"
								style="background: url('/resources/user/demos/furniture/images/categories/tables.jpg') no-repeat center center; background-size: cover; height: 340px;">
								<h5 class="text-uppercase ls1 bg-white mb-0">★★Top2</h5>
							</a>
						</div>

						<div class="col-lg-4 col-md-6">
							<a href="demo-forum-products.html" class="d-block h-op-09 op-ts"
								style="background: url('/resources/user/demos/furniture/images/categories/chairs.jpg') no-repeat center center; background-size: cover; height: 340px;">
								<h5 class="text-uppercase ls1 bg-white mb-0">★Top3</h5>
							</a>
						</div>
						<div class="col-lg-4 col-md-6">
							<a href="demo-forum-products.html" class="d-block h-op-09 op-ts"
								style="background: url('/resources/user/demos/furniture/images/categories/lights.jpg') no-repeat center center; background-size: cover; height: 340px;">
								<h5 class="text-uppercase ls1 bg-white mb-0">Lights</h5>
							</a>
						</div>
						<div class="col-lg-4 col-md-6">
							<a href="demo-forum-products.html" class="d-block h-op-09 op-ts"
								style="background: url('/resources/user/demos/furniture/images/categories/wardrobes.jpg') no-repeat center center; background-size: cover; height: 340px;">
								<h5 class="text-uppercase ls1 bg-white mb-0">Wardrobes</h5>
							</a>
						</div>
						<div class="col-lg-4 col-md-6">
							<a href="demo-forum-products.html" class="d-block h-op-09 op-ts"
								style="background: url('/resources/user/demos/furniture/images/categories/beds.jpg') no-repeat center center; background-size: cover; height: 340px;">
						...
						<div id="shop" class="shop row gutter-30 col-mb-30 mt-3">
							...
							<div class="col-xl-3 col-lg-6">
								...
								<a href="demo-furniture-products.html"
									...
									class="button button-border py-1 nott ls0 fw-normal button-dark border-width-1 border-color h-bg-color">인기
									쉐프 후기</a>
							</div>
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										<a href="demo-forum-single.html"><img
											src="/resources/user/demos/furniture/images/shop/2.jpg"
											alt="Light Grey Sofa"></a> <a href="demo-forum-single.html"><img
											src="/resources/user/demos/furniture/images/shop/2-1.jpg"
										...
										<div class="bg-overlay">
											<div
												...
												<a href="#" class="btn btn-light me-2"><i
													class="icon-line-shopping-cart"></i></a> <a
													href="/resources/user/demos/furniture/ajax/quick-view.html"
													class="btn btn-light" data-lightbox="ajax"><i
									...
									<div class="product-desc">
										<div class="product-title mb-0">
											<h4 class="mb-0">
												<a class="fw-medium" href="demo-forum-single.html">Light
													Grey Sofa</a>
											</h4>
										</div>
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										<a href="demo-forum-single.html"><img
											src="/resources/user/demos/furniture/images/shop/3.jpg"
											alt="Celling Lights"></a> <a href="demo-forum-single.html"><img
											src="/resources/user/demos/furniture/images/shop/3-1.jpg"
									...
									<div class="product-desc">
										<div class="product-title mb-0">
											<h4 class="mb-0">
												<a class="fw-medium" href="demo-forum-single.html">Celling
													Lights</a>
											</h4>
										</div>
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										<a href="demo-forum-single.html"><img
											src="/resources/user/demos/furniture/images/shop/4-1.jpg"
											alt="High Stand Chair"></a> <a
											href="demo-forum-single.html"><img
											src="/resources/user/demos/furniture/images/shop/4.jpg"
									...
									<div class="product-desc">
										<div class="product-title mb-0">
											<h4 class="mb-0">
												<a class="fw-medium" href="demo-forum-single.html">High
													Stand Chair</a>
											</h4>
										</div>
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										<a href="demo-forum-single.html"><img
											src="/resources/user/demos/furniture/images/shop/5.jpg"
											alt="Dining Sofa with Tea-table"></a> <a
											href="demo-forum-single.html"><img
											src="/resources/user/demos/furniture/images/shop/5-1.jpg"
									...
									<div class="product-desc">
										<div class="product-title mb-0">
											<h4 class="mb-0">
												<a class="fw-medium" href="demo-forum-single.html">Dining
													Sofa with Tea-table</a>
											</h4>
										</div>
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										<a href="demo-forum-single.html"><img
											src="/resources/user/demos/furniture/images/shop/6.jpg"
									...
									<div class="product-desc">
										<div class="product-title mb-0">
											<h4 class="mb-0">
												<a class="fw-medium" href="demo-forum-single.html">Bathroom
													Cloths Shelves</a>
											</h4>
										</div>
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										<a href="demo-forum-single.html"><img
											src="/resources/user/demos/furniture/images/shop/7.jpg"
									...
									<div class="product-desc">
										<div class="product-title mb-0">
											<h4 class="mb-0">
												<a class="fw-medium" href="demo-forum-single.html">Golden
													Lamp for Room</a>
											</h4>
										</div>
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										<a href="demo-forum-single.html"><img
											src="/resources/user/demos/furniture/images/shop/8.jpg"
											alt="White Cuddle Chair with Cusions"></a><a
											href="demo-forum-single.html"><img
											src="demos/furniture/images/shop/8-1.jpg"
									...
									<div class="product-desc">
										<div class="product-title mb-0">
											<h4 class="mb-0">
												<a class="fw-medium" href="demo-forum-single.html">White
													Cuddle Chair with Cusions</a>
											</h4>
										</div>
				...
				<div class="container-fluid">
					...
					<div class="row align-items-lg-center col-mb-30">
						...
						<div class="col-xl-8 col-lg-6 px-lg-0 min-vh-50 min-vh-lg-75"
							style="background: url('/resources/user/demos/furniture/images/section.jpg') no-repeat center center; background-size: cover;">
						</div>

						<!-- Content -->
						<div class="col-xl-4 col-lg-6 px-lg-5 py-5">
							<h3 class="h1 mb-4 fw-normal">
								Explore your <span data-animate="svg-underline-animated"
									class="svg-underline nocolor"><span>Home</span></span> & <span
									data-animate="svg-underline-animated" data-delay="300"
									class="svg-underline nocolor"><span>Office</span></span> with
								our Furnitures
							</h3>
							<p>Compellingly cultivate synergistic infrastructures rather
								than fully tested opportunities. Synergistically evisculate
								web-enabled interfaces for market positioning web services.
								Continually create business infomediaries and interdependent
								products.</p>
							<a href="demo-forum-about.html"
				...
				============================================= -->
				<div class="section custom-bg mt-lg-0 mb-0 py-6"
					style="-custom-bg: #fdf3e7;">
								...
								<div class="feature-box fbox-center fbox-dark fbox-plain">
									<div class="fbox-icon">
										<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64"
											...
											<path
												d="M54.46089,201.53911c-9.204-9.204-3.09935-28.52745-7.78412-39.85C41.82037,149.95168,24,140.50492,24,127.99963,24,115.4945,41.82047,106.048,46.67683,94.31079c4.68477-11.32253-1.41993-30.6459,7.78406-39.8499s28.52746-3.09935,39.85-7.78412C106.04832,41.82037,115.49508,24,128.00037,24c12.50513,0,21.95163,17.82047,33.68884,22.67683,11.32253,4.68477,30.6459-1.41993,39.8499,7.78406s3.09935,28.52746,7.78412,39.85C214.17963,106.04832,232,115.49508,232,128.00037c0,12.50513-17.82047,21.95163-22.67683,33.68884-4.68477,11.32253,1.41993,30.6459-7.78406,39.8499s-28.52745,3.09935-39.85,7.78412C149.95168,214.17963,140.50492,232,127.99963,232c-12.50513,0-21.95163-17.82047-33.68884-22.67683C82.98826,204.6384,63.66489,210.7431,54.46089,201.53911Z"
												fill="none" stroke="var(--themecolor)"
												stroke-linecap="round" stroke-linejoin="round"
												stroke-width="8"></path>
											<polyline points="172 104 113.333 160 84 132" fill="none"
												stroke="var(--themecolor)" stroke-linecap="round"
												stroke-linejoin="round" stroke-width="8"></polyline></svg>
									</div>
									<div class="fbox-content">
										<h2 class="nott fw-medium h4 mb-4">Original & Excellent
											Quality</h2>
										<p class="op-06">Completely formulate top-line resources
											rather than cross-media portals cross-platform solutions.</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4">
								<div class="feature-box fbox-center fbox-dark fbox-plain">
									<div class="fbox-icon">
										<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64"
											...
											<path
												...
												opacity="0.2"></path>
											<path d="M240,120H176V80h42.58374a8,8,0,0,1,7.42781,5.02887Z"
												fill="none" stroke="var(--themecolor)"
												stroke-linecap="round" stroke-linejoin="round"
												stroke-width="8"></path>
											...
											<circle cx="188" cy="192" r="24" fill="none"
												stroke="var(--themecolor)" stroke-miterlimit="10"
												stroke-width="8"></circle>
											<circle cx="68" cy="192" r="24" fill="none"
												stroke="var(--themecolor)" stroke-miterlimit="10"
												stroke-width="8"></circle>
											...
											<path
												...
												stroke-linecap="round" stroke-linejoin="round"
												stroke-width="8"></path>
											<path d="M176,171.21508V120h64v64a8,8,0,0,1-8,8H212"
												fill="none" stroke="var(--themecolor)"
												stroke-linecap="round" stroke-linejoin="round"
									...
									<div class="fbox-content">
										...
										<p class="op-06">Rapidiously optimize user-centric
											catalysts for change vis-a-vis granular "outside the box"
											thinking.</p>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4">
								<div class="feature-box fbox-center fbox-dark fbox-plain">
									...
									<div class="fbox-content">
										...
										<p class="op-06">Continually recaptiualize 2.0 action
											items after global information. Efficiently strategize
											holistic networks.</p>
									</div>
								</div>
							</div>
							...
							<div class="text-center dark p-5">
								<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64"
									...
									<path
										...
										opacity="0.2"></path>
									<circle cx="128" cy="128" r="40" fill="none" stroke="#FFF"
										stroke-miterlimit="10" stroke-width="16"></circle>
									<rect class x="36" y="36" width="184" height="184" rx="48"
										stroke-width="16" stroke="#FFF" stroke-linecap="round"
										stroke-linejoin="round" fill="none"></rect>
									<circle cx="180" cy="75.99998" r="12"></circle></svg>

								<h3 class="mt-3 mb-5 fw-normal h2">
									Follow us on <span data-animate="svg-underline-animated"
										class="svg-underline nocolor"><span>Instagram</span></span>
								</h3>
						...
						<div class="col-lg-4 col-md-6 order-lg-1">
							<div class="row gutter-4">
								...
								<div class="col-6">
									<a class="d-block instagram-image"
										href="https://instagram.com/semicolonweb" target="_blank"
										style="background: url('/resources/user/demos/furniture/images/instagram/2.jpg') no-repeat center center; background-size: cover; min-height: 33vh;"></a>
								</div>
								<div class="col-6">
									<a class="d-block instagram-image"
										href="https://instagram.com/semicolonweb" target="_blank"
										style="background: url('/resources/user/demos/furniture/images/instagram/3.jpg') no-repeat center center; background-size: cover; min-height: 33vh;"></a>
								</div>
								<div class="col-6">
									<a class="d-block instagram-image"
										href="https://instagram.com/semicolonweb" target="_blank"
										style="background: url('/resources/user/demos/furniture/images/instagram/4.jpg') no-repeat center center; background-size: cover; min-height: 33vh;"></a>
								</div>
							</div>
						</div>
						...
						<div
							...
							<div class="row gutter-4">
								...
								<div class="col-6">
									<a class="d-block instagram-image"
										href="https://instagram.com/semicolonweb" target="_blank"
										style="background: url('/resources/user/demos/furniture/images/instagram/6.jpg') no-repeat center center; background-size: cover; min-height: 33vh;"></a>
								</div>
								<div class="col-6">
									<a class="d-block instagram-image"
										href="https://instagram.com/semicolonweb" target="_blank"
										style="background: url('/resources/user/demos/furniture/images/instagram/7.jpg') no-repeat center center; background-size: cover; min-height: 33vh;"></a>
								</div>
								<div class="col-6">
									<a class="d-block instagram-image"
										href="https://instagram.com/semicolonweb" target="_blank"
										style="background: url('/resources/user/demos/furniture/images/instagram/8.jpg') no-repeat center center; background-size: cover; min-height: 33vh;"></a>
								</div>
							</div>
						</div>
					</div>
