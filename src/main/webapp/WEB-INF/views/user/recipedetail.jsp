...
<html dir="ltr" lang="en-US">
  <head>
    ...
    <link rel="stylesheet" href="resources/css/colors.php?color=267DF4" type="text/css" />
    <!-- Theme Color -->
    <link rel="stylesheet" href="resources/demos/recipes/css/fonts.css" type="text/css" />
    <!-- Theme Font -->
    <link rel="stylesheet" href="resources/demos/recipes/recipes.css" type="text/css" />
    <!-- Theme Custom CSS -->
  ...
  <body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
            ...
            <div class="header-row">
              ...
              <div id="logo">
                <a href="index.html" class="standard-logo"
                  ><img src="demos/recipes/images/logo.png" alt="Canvas Logo"
                /></a>
                <a href="index.html" class="retina-logo"
                  ><img
                    src="demos/recipes/images/logo@2x.png"
                    alt="Canvas Logo"
                /></a>
              </div>
              <!-- #logo end -->
              ...
              <nav class="primary-menu">
                <ul class="menu-container">
                  <li class="menu-item current">
                    <a class="menu-link" href="demo-recipes.html"
                      ><div>Home</div></a
                    >
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="demo-recipes-about-us.html"
                      ><div>About Us</div></a
                    >
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="demo-recipes-recipes.html"
                      ><div>
                        Recipes
                        <i
                          class="icon-angle-down1 d-none d-lg-inline-block"
                        ></i></div
                    ></a>
                    <ul class="sub-menu-container rounded-bottom">
                      ...
                      <li class="menu-item">
                        <a class="menu-link" href="demo-recipes-recipes.html"
                          ><div>Most liked</div></a
                        >
                      </li>
                      <li class="menu-item">
                        <a class="menu-link" href="demo-recipes-recipes.html"
                          ><div>Most Commented</div></a
                        >
                      </li>
                    </ul>
                  </li>
                  <li class="menu-item">
                    <a class="menu-link" href="demo-recipes-contact.html"
      ...
      <section
        ...
        style="
          background: #111 url('demos/recipes/images/recipe-single.jpg') center
            center / cover;
          padding: 230px 0;
        "
        ...
        <div class="container clearfix">
          ...
          <div class="mx-auto center" style="max-width: 900px">
            <div class="slider-features" data-animate="zoomIn" data-delay="300">
              <ul
                class="list-unstyled row g-0 align-items-center overflow-hidden col-mb-50 mt-5"
              >
          ...
          <div class="container">
            <div class="card border-0 shadow-sm" style="top: -100px">
              <div class="card-body px-4">
                <div
                  class="row align-items-center justify-content-between py-3"
                >
                  <div class="col-12 col-xl">
                    <div class="row justify-content-center col-mb-30">
                      <div class="col-4 col-md">
                        <h6
                          class="text-black-50 text-uppercase font-body fw-normal ls1 mb-1"
                        >
                          Energy
                        </h6>
                  ...
                  <div class="col-12 text-center col-xl-auto mt-5 mt-xl-0">
                    <a href="#" class="button button-circle m-0"
                      ><i class="icon-line-cloud-download"></i> Download</a
                    >
                  </div>
                </div>
                ...
                <div class="row justify-content-between mt-5 mb-4 clearfix">
                  <div class="col-lg-4">
                    ...
                    >
                      ...
                      <a
                        ...
                        id="print-button"
                        class="social-icon si-small si-colored si-print"
                        title="Print"
                      >
                    ...
                    <a
                      href="#"
                      class="social-icon si-small si-colored si-twitter"
                      title="Twitter"
                    >
                    ...
                    <a
                      href="#"
                      class="social-icon si-small si-colored si-pinterest"
                      title="Pinterest"
                    >
                    ...
                    <a
                      href="#"
                      class="social-icon si-small si-colored si-instagram"
                      title="Instagram"
                    >
                    ...
                    <a
                      href="#"
                      class="social-icon si-small si-colored si-email3"
                      title="Email"
                    >
                  ...
                  <div class="col-lg-8 mt-5 mt-lg-0">
                    <h4>Video</h4>
                    <div
                      class="rounded position-relative dark mb-5"
                      style="
                        background: url('demos/recipes/images/recipe-week.jpg')
                    ...
                    >
                      <a
                        ...
                        class="play-video stretched-link"
                      >
                        <i class="icon-play"></i>
                      </a>
                    </div>
                    ...
                    <ol class="list-unstyled list-preparation">
                      ...
                      <li>
                        In a small bowl, combine all ingredients for honey
                        mustard dressing.
                      </li>
                      <li>
                        Pour the dressing on the chicken and tots. Top with
                        onion, then cheddar and monterey jack cheese.
                      </li>
                      <li>
                        Broil from 5-10 minutes, or until cheese is melted.
                      </li>
                      <li>
                        Load the dish with tomatoes, avocados, sour cream, and
                    ...
                    >
                      <div class="col-12 col-md-auto text-center">
                        <a href="#"
                          >&lArr; This is a Standard post with a Slider
                          Gallery</a
                        >
                      </div>
                            ...
                            <div class="comment-meta">
                              <div class="comment-author vcard">
                                <span class="comment-avatar clearfix">
                                  <img
                                    alt="Image"
                                    src="demos/articles/images/authors/2.jpg"
                              ...
                              <div class="comment-author">
                                Gunther David<span
                                  ><a href="#" title="Permalink to this comment"
                                    >April 24, 2012 at 10:46 am</a
                                  ></span
                                >
                                <small class="comment-ratings text-muted mt-2"
                            ...
                            <div class="comment-meta">
                              <div class="comment-author vcard">
                                <span class="comment-avatar clearfix">
                                  <img
                                    alt="Image"
                                    src="demos/articles/images/authors/1.jpg"
                      ...
                      <div id="respond">
                        ...
                        >
                          <div class="col-md-4 form-group">
                            <label class="nott ls0 fw-normal" for="author"
                              >Name</label
                            >
                            <input
                              type="text"
                          ...
                          <div class="col-md-4 form-group">
                            <label class="nott ls0 fw-normal" for="email"
                              >Email</label
                            >
                            <input
                              type="text"
                          ...
                          <div class="col-md-4 form-group">
                            <label class="nott ls0 fw-normal" for="rating"
                              >Rating</label
                            >
                          ...
                          <div class="col-12 form-group">
                            <label class="nott ls0 fw-normal" for="comment"
                              >Comment</label
                            >
                            <textarea
                              name="comment"
            ...
            <div class="related-posts recipe-items">
              <div class="row g-0">
                <div
                  class="col-md-3 col-sm-6 bg-white"
                  style="border-left: 1px solid #eee"
                >
                  <div class="card">
                    <div class="card-body">
                      <img
                        src="demos/recipes/images/popular/7.png"
                        alt="image"
                      />
                      <div
                      ...
                      >
                        ...
                        <span class="badge bg-primary bg-color"
                          ><i class="icon-star3"></i> 4.5</span
                        >
                      </div>
                      <h3 class="card-title">
                        <a href="#" class="stretched-link"
                          >Baked Salmon with Sweet-Potatoes</a
                        >
                      </h3>
                      <h5 class="card-date">
                ...
                <div class="col-md-3 col-sm-6 bg-white">
                  <div class="card">
                    <div class="card-body">
                      <img
                        src="demos/recipes/images/popular/8.png"
                        alt="image"
                      />
                      <div
                        class="d-flex justify-content-between align-items-center mt-4 mb-2"
                      >
                        ...
                        <span class="badge bg-primary bg-color"
                          ><i class="icon-star3"></i> 4.2</span
                        >
                      </div>
                      <h3 class="card-title">
                        <a href="#" class="stretched-link"
                          >A Kollam Grilled Cheese with Vegetables</a
                        >
                      </h3>
                      <h5 class="card-date">
                ...
                <div class="col-md-3 col-sm-6 bg-white">
                  <div class="card">
                    <div class="card-body">
                      <img
                        src="demos/recipes/images/popular/5.png"
                        alt="image"
                      />
                      <div
                        class="d-flex justify-content-between align-items-center mt-4 mb-2"
                      ...
                      <h3 class="card-title">
                        <a href="#" class="stretched-link"
                          >Pumpkin Bars with Cream Cheese Frosting</a
                        >
                      </h3>
                      <h5 class="card-date">
                ...
                <div class="col-md-3 col-sm-6 bg-white">
                  <div class="card">
                    <div class="card-body">
                      <img
                        src="demos/recipes/images/popular/6.png"
                        alt="image"
                      />
                      <div
                        class="d-flex justify-content-between align-items-center mt-4 mb-2"
                      >
                        ...
                        <span class="badge bg-primary bg-color"
                          ><i class="icon-star3"></i> 4.0</span
                        >
                      </div>
                      <h3 class="card-title">
                        <a href="#" class="stretched-link"
                          >The Best Homemade Pizza Recipes</a
                        >
                      </h3>
                      <h5 class="card-date">
            ...
            <div class="row">
              <div class="col-lg-2 col-md-2 col-6 pe-4">
                <div class="widget">
                  ...
                  <a href="#"
                    ><img
                      src="demos/articles/images/appstore.png"
                      alt="App Link"
                  /></a>
                  <a href="#"
                    ><img
                      src="demos/articles/images/googleplay.png"
                      alt="App Link"
                      class="mt-2"
                  /></a>
                </div>
              ...
              <div class="col-lg-2 col-md-2 col-6">
                <div class="widget">
                  ...
                  <ul class="list-unstyled ms-0">
                    ...
                    <li class="mb-2">
                      <a href="#" class="text-black-50">Support</a>
                    </li>
                  </ul>
                </div>
              </div>
              <div class="col-lg-2 col-md-2 col-6 mt-4 mt-md-0">
                <div class="widget">
                  ...
                  <ul class="list-unstyled ms-0">
                    ...
                    <li class="mb-2">
                      <a href="#" class="text-black-50">Portfolio</a>
                    </li>
                    <li class="mb-2">
                      <a href="#" class="text-black-50">Blog</a>
                    </li>
                  </ul>
                </div>
              </div>
              <div class="col-lg-2 col-md-2 col-6 mt-4 mt-md-0">
                <div class="widget">
                  ...
                  <ul class="list-unstyled ms-0">
                    <li class="mb-2">
                      <a href="#" class="text-black-50">Help Center</a>
                    </li>
                    <li class="mb-2">
                      <a href="#" class="text-black-50">Paid with Moblie</a>
                    </li>
                    <li class="mb-2">
                      <a href="#" class="text-black-50">Status</a>
                    </li>
                    <li class="mb-2">
                      <a href="#" class="text-black-50">Contact Support</a>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div id="copyrights" class="bg-light">
          <div class="container">
            <div class="row justify-content-between align-items-center">
              ...
              <div
                class="col-sm-4 d-flex justify-content-sm-center mb-3 mb-sm-0"
              >
                <a
                ...
                <a
                  href="https://www.youtube.com/semicolonweb"
                  target="_blank"
                  class="social-icon si-small si-colored si-youtube"
                  title="youtube"
                >
