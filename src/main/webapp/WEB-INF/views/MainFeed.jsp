				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div id="logo" class="mx-auto col-auto flex-column order-2">
							<a href="demo-furniture.html" class="standard-logo"><img src="demos/furniture/images/logo1.png" alt="coobby Logo"></a>
							<a href="demo-furniture.html" class="retina-logo"><img src="demos/furniture/images/logo1.png" alt="Coobby Logo"></a>
						</div><!-- #logo end -->
							...
							<div class="product col-lg-3 col-md-4 col-sm-6 col-12">
								<div class="grid-inner">
									<div class="product-image">
										...
										<div>
											<a href="3_feed_con.html" class="btn btn-light" data-lightbox="ajax">
