					...
					<div class="product modal-padding">
						...
						<div class="row gutter-50 col-mb-50">
                                    ...
                                    <div class="fslider" data-pagi="false">
                                        <div class="flexslider">
                                            <div class="slider-wrap">
                                                <div class="slide"><img src="resources/images/testimg.jpg" alt="test"></div>
                                                <div class="slide"><img src="resources/images/testimg2.png" alt="test"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
							...
							<div class="col-md-6 product-desc content-sticky">
								<h2 class="mb-3 fw-normal">myfeed title</h2>
								<!-- 내용 -->
								<!-- 유저정보 -->
								<div id="feeduser">
									<h3 class="userId mb-4 fw-semibold">userId</h3>
								...
								<!-- 댓글 끝 -->
								<a href="feed/UpdateMyFeed" class="button button-3d button-rounded button-pink"><i class="icon-line-edit-3"></i>수정하기</a>
								<a href="#" class="button button-3d button-rounded button-red"><i class="icon-line-trash-2"></i>삭제하기</a>
							</div>
						</div>
